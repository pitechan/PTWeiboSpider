...
class Captcha:
    ...
    def new():
        ...
        cap_pic = requests_session.get('http://weibo.cn/interface/f/ttt/captcha/show.php?cpt=' + cap_id,
                                       headers=HEADERS)
        ...
        if code == 'n':
            ...
            captcha = Captcha(requests_session, cap_id, vk, code, login_url)
            captcha.password_vk = 'password_' + str(vk.split('_')[0])
            return captcha
